...
const ProtectedRoute = ({ children, role }) => {
    ...
    console.log(`[ProtectedRoute-TRACE] Path: ${window.location.pathname}, Role: ${userRole}, Required: ${requiredRoles}`);
    ...
    if (role && !requiredRoles.includes(userRole)) {
        ...
        if (userRole === 'employee' || userRole === 'seo-team') return <Navigate to="/employee/dashboard" replace />;
