                        ...
                        .map(conv => (
                            ...
                            >
                                <div className="relative">
                                    <img src={conv.profilePicture ? (conv.profilePicture.startsWith('http') ? conv.profilePicture : `${conv.profilePicture?.startsWith('http') ? conv.profilePicture : import.meta.env.VITE_API_URL + conv.profilePicture}`) : `https://ui-avatars.com/api/?name=${conv.name}`} className="w-12 h-12 rounded-2xl object-cover" alt="" />
                                    {!conv.isGroup && (
