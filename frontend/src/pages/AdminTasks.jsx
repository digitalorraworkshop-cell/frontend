                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    ...
                                    >Admin</button>
                                    <button
                                        onClick={() => setFilters({ ...filters, assignType: 'MANAGER' })}
                                        className={`flex-1 py-3 rounded-xl text-[10px] font-black uppercase ${filters.assignType === 'MANAGER' ? 'bg-amber-600 text-white' : 'bg-slate-50 text-slate-400'}`}
                                    >Manager</button>
                                    <button
                                            ...
                                            <tr key={task._id} className="group hover:bg-slate-50/50 transition-all duration-300">
                                                ...
                                                <td className="px-6 py-7 text-center">
                                                    <span className={`px-2 py-0.5 rounded-md text-[9px] font-black uppercase ${
                                                        task.assignType === 'ADMIN' ? 'bg-indigo-50 text-indigo-600' : 
                                                        task.assignType === 'MANAGER' ? 'bg-amber-50 text-amber-600' :
