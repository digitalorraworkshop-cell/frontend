...
const AdminDashboard = () => {
    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            try {
                const { data: attendanceStats } = await api.get('/attendance/stats');

                setStats({
                    totalEmployees: attendanceStats.totalEmployees,
                    activeNow: attendanceStats.workingEmployees,
                    todayPresent: attendanceStats.todayPresent,
                    todayAbsent: attendanceStats.todayAbsent,
                    lateEmployees: attendanceStats.lateEmployees,
                    avgWorkHours: attendanceStats.avgWorkHours
                });

                // const { data: logs } = await api.get('/activity/recent'); 
