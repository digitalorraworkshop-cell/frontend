...
const Login = () => {
    ...
    useEffect(() => {
        ...
        if (user) {
            ...
            if (role === 'admin' || role === 'seo-manager' || role === 'assets-manager' || role === 'manager') {
                navigate('/admin', { replace: true });
            } else if (role === 'employee' || role === 'seo-team') {
                navigate('/employee/dashboard', { replace: true });
            } else {
                console.warn(`[Login] Unknown role "${role}", staying on login page`);
            }
        }
