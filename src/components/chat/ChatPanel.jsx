                                    ...
                                    {filteredConversations.filter(c => isGroupMode ? c.isGroup : !c.isGroup).map(conv => (
                                        ...
                                        >
                                            <div className="relative">
                                                <img
                                                    src={conv.profilePicture ? (conv.profilePicture.startsWith('http') ? conv.profilePicture : `${conv.profilePicture?.startsWith('http') ? conv.profilePicture : import.meta.env.VITE_API_URL + conv.profilePicture}`) : `https://ui-avatars.com/api/?name=${conv.name}&background=6366f1&color=fff`}
