                                    ...
                                    {filteredConversations.filter(c => isGroupMode ? c.isGroup : !c.isGroup).map(conv => (
                                        ...
                                        >
                                            <div className="relative">
                                                <img
                                                    src={conv.profilePicture ? (conv.profilePicture.startsWith('http') ? conv.profilePicture : `http://localhost:5001${conv.profilePicture}`) : `https://ui-avatars.com/api/?name=${conv.name}&background=6366f1&color=fff`}
