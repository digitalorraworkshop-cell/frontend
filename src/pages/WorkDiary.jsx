                    ...
                    {screenshots.map((shot, i) => (
                        <div key={i} className="group bg-white rounded-[40px] overflow-hidden shadow-sm border border-slate-100 hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-500">
                            <div className="relative aspect-video overflow-hidden bg-slate-100">
                                <img src={shot.imageUrl.startsWith('http') ? shot.imageUrl : `${import.meta.env.VITE_API_URL || 'http://localhost:5001'}${shot.imageUrl}`} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" alt="" />
